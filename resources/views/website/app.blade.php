            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-4 site-logo">
                        <a href="index.html" class="text-black h2 mb-0">{{ config('app.name') }}</a>
                    </div>
        ...
        <div class="site-footer">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-4">
                        ...
                        <p>{{ $setting->description ?? 'Description' }} </p>
                    </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p>
                        Copyright &copy; {{ $setting->copyright }} | Template: <a href="https://colorlib.com" target="_blank" >Colorlib</a>
                    </p>
                </div>
            </div>
        </div>
